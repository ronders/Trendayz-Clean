		...
		<div class="fpd-edit-elements">
			...
			<div class="fpd-toolbar fpd-clearfix">
				...
				<div class="fpd-helper-buttons-wrapper">
					...
					<span title="<?php echo $customize_center_move_down; ?>" class="fpd-move-down ui icon button fpd-tooltip"><i class="fa fa-arrow-down icon"></i></span>
					<span title="<?php echo $customize_center_move_up; ?>" class="fpd-move-up ui icon button fpd-tooltip"><i class="fa fa-arrow-up icon"></i></span>
