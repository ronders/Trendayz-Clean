	...
	<?php } ?>  
      <div class="well">
        <div class="row">
		  ...
		  <div class="col-sm-3">
            <div class="form-group">
              <label class="control-label" for="input-name"><?php echo $entry_product_design; ?></label>
              <input type="text" name="filter_product_design" value="<?php echo $filter_product_design; ?>" placeholder="<?php echo $entry_product_design; ?>" id="input-name" class="form-control" />
            </div>
          </div>
          <div class="col-sm-3">
            <div class="form-group">
        ...
        <div class="table-responsive">
          <table class="table table-bordered table-hover">
            ...
            <tbody>
              ...
              <tr>
                <td class="text-center"><?php if (in_array($product['product_ideas_id'], $selected)) { ?>
                  <input type="checkbox" name="selected[]" value="<?php echo $product['product_ideas_id']; ?>" checked="checked" />
                  <?php } else { ?>
                  <input type="checkbox" name="selected[]" value="<?php echo $product['product_ideas_id']; ?>" />
                  <?php } ?></td>
                <td class="text-left"><?php if ($product['image']) { ?>
...
$('#button-filter').on('click', function() {
	var url = 'index.php?route=catalog/fnt_product_ideas&token=<?php echo $token; ?>';
	...
	var filter_product_design = $('input[name=\'filter_product_design\']').val();
	
	if (filter_product_design) {
		url += '&filter_product_design=' + encodeURIComponent(filter_product_design);
	}
