...
class ControllerFancyDesignSidebar extends Controller {
	public function index() { 
		...
		$this->data['choose_products_menu'] = $this->language->get('choose_products_menu');
		$this->data['designs_menu'] = $this->language->get('designs_menu');
		$this->data['choose_designs_menu'] = $this->language->get('choose_designs_menu');
		$this->data['elements_menu'] = $this->language->get('elements_menu');
		$this->data['edit_elements_menu'] = $this->language->get('edit_elements_menu');
		$this->data['photos_menu'] = $this->language->get('photos_menu');
		$this->data['user_photos_menu'] = $this->language->get('user_photos_menu');	
		$this->data['fb_photos_menu'] = $this->language->get('fb_photos_menu');
		$this->data['insta_photos_menu'] = $this->language->get('insta_photos_menu');
		$this->data['products_ideas'] = $this->language->get('products_ideas');
		$this->data['fb_photos'] = $this->language->get('fb_photos');
		$this->data['insta_photos'] = $this->language->get('insta_photos');
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/fancy_design/sidebar.tpl')) {
			$this->template = $this->config->get('config_template') . '/template/fancy_design/sidebar.tpl';
		} else {
			$this->template = 'default/template/fancy_design/sidebar.tpl';
		}
